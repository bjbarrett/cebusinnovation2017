...
save(d,mD,file="14Mardomainzeros.RData")
...
save(mD,mD.ageglobal,mD.male,mD.soc,mD.rank,mD.age,d, file="19Marinnovation>1.Rdata")
save(mD.ageglobal,mD.age,d, file="22Marinnovationall.Rdata")
