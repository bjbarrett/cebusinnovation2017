...
setwd("~/Dropbox/InnovationProject/Analysis/final analysis/Final > 1 year > 20scans")

#d <- read.csv("~/Dropbox/InnovationProject/Analysis/PNASfinaldomainindividual2.csv" , header=TRUE)
#inno <- read.csv("~/Dropbox/InnovationProject/Analysis/PNASinnolong2.csv" , header=TRUE)

#d <- read.csv("~/data_inno_domain_git.csv" , header=TRUE) #direct to local directory
d <- read.csv("PNASfinaldomainindividual2.csv" , header=TRUE) #direct to local directory
#inno <- read.csv("PNASinnolong2.csv" , header=TRUE)
inno <- read.csv("PNASinnovationlistused2.csv" , header=TRUE)

length(unique(inno$behavior_index))
length(unique(inno$behav_code)

length(unique(inno$behav_code[inno$others==1]))
###innoused
...
write.csv(i,"PNASinnovationlistused2.csv")
...
###plots
pdf("probobservedinothersoc2.pdf", width=8.5 , height=8.5 )
...
###plots
pdf("probobservedinothergroup2.pdf", width=8.5 , height=8.5 )
